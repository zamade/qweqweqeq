...
Grad3.Parent = Sep3;
		...
		function main:PlayerCard()
			...
			CardBackground.Parent = CardContainer;
			CardBackground.BackgroundColor3 = Color3.fromRGB(20, 10, 10);
			CardBackground.BackgroundTransparency = 0;
			...
			InfoFrame.Size = UDim2.new(1, -100, 1, 0);
			InfoFrame.Position = UDim2.new(0, 94, 0, 0);
			...
			UserIDLabel.Position = UDim2.new(0, 0, 0, 28);
			...
			TagLabel.Position = UDim2.new(0, 0, 0, 46);
			TagLabel.Size = UDim2.new(0, 70, 0, 20);
			TagLabel.BorderSizePixel = 0;
			TagLabel.Text = "Key Sistem";
